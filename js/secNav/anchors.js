...
//First btn
const rep1 = ["Hela bioprogrammet", "hela-bioprogrammet"];
const rep2 = ["Kommande premiärer", "kommande-premiarer"];
...
//Fifth btn
const barBist1 = ["Meny", "bistro-meny"];
const barBist2 = ["Premiärfredag", "premiarfredagar"];
